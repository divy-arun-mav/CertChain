...
const CourseLearning = () => {
    ...
    return (
        <div className="overflow-hidden flex bg-gray-900 text-white">
            <div className="w-1/4 bg-gray-800 p-6 h-screen overflow-y-scroll">
            ...
            <div className="w-3/4 p-8 mt-10 h-screen overflow-y-auto">
                {selectedModule ? (
                    <>
                        ...
                        <div className="mt-20">
                            ...
                            <p className="text-gray-400">{selectedModule.learn}</p>
                            <p className="text-gray-400">{selectedModule.learn}</p>
                            <p className="text-gray-400">{selectedModule.learn}</p>
                        </div>
                        <div className="mt-8 flex justify-end">
                            <button
                                onClick={nextModule}
                                className={`visible px-6 py-2 rounded-lg ${course && selectedModule && course.modules.findIndex(module => module.moduleId === selectedModule.moduleId) < course.modules.length - 1
                                        ? "bg-[#00A8E8] text-black hover:bg-[#0086C7]"
                                        : "bg-gray-600 cursor-not-allowed"
                                    }`}
                                disabled={!course || !selectedModule || course.modules.findIndex(module => module.moduleId === selectedModule.moduleId) >= course.modules.length - 1}
                            >
                                Next Module
                            </button>
                        </div>
